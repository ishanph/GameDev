...
function love.keypressed(key)
    ...
    if paused and key == 'p' then
        paused = false
        love.graphics.discard(pause)
    elseif (not paused) and key == 'p' then
        paused = true
    end
...
function love.draw()
    ...
    if paused then
        love.graphics.draw(pause,VIRTUAL_WIDTH/2-30,VIRTUAL_HEIGHT/2-30,0,1/3,1/3)
    end
